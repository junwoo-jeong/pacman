...
public class Inky extends Sprite implements Moveable{
	private int dx;
	private int dy;
	...
	private Image upImage = new ImageIcon(getClass().getResource("../resourse/img/inkyUP.png")).getImage();
	private Image downImage = new ImageIcon(getClass().getResource("../resourse/img/inkyDOWN.png")).getImage();
	private Image leftImage = new ImageIcon(getClass().getResource("../resourse/img/inkyLEFT.png")).getImage();
	private Image rightImage = new ImageIcon(getClass().getResource("../resourse/img/inkyRIGHT.png")).getImage();
