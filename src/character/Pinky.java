...
public class Pinky extends Sprite implements Moveable{
	private int dx;
	private int dy;
	...
	private Image upImage = new ImageIcon(getClass().getResource("../resourse/img/pinkyUP.png")).getImage();
	private Image downImage = new ImageIcon(getClass().getResource("../resourse/img/pinkyDOWN.png")).getImage();
	private Image leftImage = new ImageIcon(getClass().getResource("../resourse/img/pinkyLEFT.png")).getImage();
	private Image rightImage = new ImageIcon(getClass().getResource("../resourse/img/pinkyRIGHT.png")).getImage();
