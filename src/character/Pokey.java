...
public class Pokey extends Sprite implements Moveable{
	private int dx;
	private int dy;
	...
	private Image upImage = new ImageIcon(getClass().getResource("../resourse/img/pokeyUP.png")).getImage();
	private Image downImage = new ImageIcon(getClass().getResource("../resourse/img/pokeyDOWN.png")).getImage();
	private Image leftImage = new ImageIcon(getClass().getResource("../resourse/img/pokeyLEFT.png")).getImage();
	private Image rightImage = new ImageIcon(getClass().getResource("../resourse/img/pokeyRIGHT.png")).getImage();
